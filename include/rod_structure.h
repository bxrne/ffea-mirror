...
struct Rod
{
  ...
  /** Nearest neighbour coordinates for steric interactions are stored as a 2D array, with fixed rows and dynamic columns  */
  std::vector<float> * steric_interaction_coordinates;  /** TODO: description */
